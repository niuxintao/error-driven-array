...
2)\textbf{the F-measure of MFS identification} The results of the quality of MFS identification by FDA-CIT is listed in Table \ref{f-measure-fda-cit}. Then same as previous metric, we also list the comparison between fda-cit with \emph{ict} and \emph{sct} are also attached.
...
This table shows a very clear gap between. In fact, 
...
The result is listed in Figure \ref{ex2_result}.
