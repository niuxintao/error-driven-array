...
\hline
Tomcat   &         &   \\
HSQLDB   &   $2^{9} \times 3^{2} \times 4^{1}$      &  3-degree (3)  \\
GCC      &         &      \\
JFlex    & $2^{10} \times 3^{2} \times 4^{1} $        &     \\
Tcas     &   &   
\end{tabular}
...
There are several threats to validity in our empirical studies. First,  software. Second, many more generation algorithm and MFS isolation algorithms are needed. Third, these empirical studies are all on the deterministic condition,
