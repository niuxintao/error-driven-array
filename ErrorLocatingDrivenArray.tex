...
\subsubsection{Study setup}
We use FDA-CIT to identify.  We gather the overall test cases (we don't separately count the identification test cases and generation test cases as FDA-CIT does not need to additional test cases to identify the MFS), MFS identification(including re-call, precise and f-measure), the t-tested-coverage, multiple MFS and the rate of schemas coverage.
