...
(2) \emph{MFS identification} : Traditional MFS identification aims at finding the MFS in one failing test case. As discussed before, . Originally, one additional test case generated in the identification process can be formulated as \ref{eq3}.
