...
\subsection{Multiple MFS in one test case}
...
Thus, although the technique can conclude that the desired
interaction coverage is achieved, many option combinations may actually not be
tested. The approach in [10] also uses feedback from fault localization, but to
address the problem of inadequate testing. This approach can give false
confidence that the desired t-way testing is completed.
...
\subsection{Problems that solved}
